%% chengyu zhang
% get condition-specific model based on rosemarys' dataset
...
% exp1a = readmatrix('data\1a mean.xlsx');
...
%% save model
cd D:\model_research\yeast_GEM_multi_omics_analysis\regulation_analysis_for_yeast9\get_fluxandproteoimcs\output
