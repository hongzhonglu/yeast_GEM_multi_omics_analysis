...
import pandas as pd
from cobra.flux_analysis.deletion import double_gene_deletion, single_gene_deletion
import os
from temp_pre import temp9
import datetime
...
exp = pd.read_csv(r'D:\model_research\yeast_GEM_multi_omics_analysis\synthetic lethal\data\science2004SI.csv')
...
print('start double_gene_deletion')
starttime = datetime.datetime.now()
deletion = double_gene_deletion(model,
                                gene_list1=pair1,
                                gene_list2=pair2)
endtime = datetime.datetime.now()
print('double_gene_deletion run for:')
